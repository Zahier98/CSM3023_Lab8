<%-- 
    Document   : carList
    Created on : 18 Jun 2024, 4:45:40 pm
    Author     : Zahier
--%>
                    ...
                    <table class="table table-bordered mt-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="edit?id=<c:out value='${car.id}' />"><i class="fa-solidfa-pen-to-square"></i></a></td>
                                <td class="text-center"><a href="delete?id=<c:out value='${car.id}' />"><i class="fa-solidfa-trash"></i></a></td>
                            </tr>
                            </c:forEach>
                        </tbody>
                    </table>
